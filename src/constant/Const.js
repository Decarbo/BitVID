...
export const Youtubeapi = `https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&chart=mostPopular&regionCode=IN&maxResults=10&videoCategoryId=CATEGORY_ID&key=${import.meta.env.VITE_YOUTUBE_API_KEY}`;
